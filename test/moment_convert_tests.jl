...
@testset "moment mappings" begin
    ...
    μ = define_μ(2, 3)
    κ = cumulants_to_raw_moments(2,3)
    ...
    @test isequal(expand_mod(κ[2,1]),expr)

    raw_to_central = raw_to_central_moments(2,3)
